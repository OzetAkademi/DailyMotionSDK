...
$privateApiKey = Read-Host "Private API Key (for SDK configuration)"
$privateApiSecret = Read-Host "Private API Secret (for SDK configuration)" -AsSecureString
...
dotnet user-secrets set "DailymotionOptions:PrivateApiKey" $privateApiKey
dotnet user-secrets set "DailymotionOptions:PrivateApiSecret" $privateApiSecretPlain
